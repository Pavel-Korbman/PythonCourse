...
# Режим a ((Чтение добавления данных в файл):
'''
...
'''
# Конструкция with
# Режим w ((Чтение перезаписи файла):
'''
...
'''
'''
# os.chdir('путь') - смена текущей директории.
import os
#os.chdir('C:/Users/79190/PycharmProjects/GB')
print(f'Текущая дирректория:{os.getcwd()}') #  Текущая дирректория:D:\PythonCourse
'''
#  Вложенный в os модуль os.path
'''
является вложенным модулем в модуль os и реализует некоторые
полезные функции для работы с путями, такие как:
'''
#  os.path.basename(path) - возвращает базовое имя пути (имя файла)
'''
import os

print(os.path.basename('D:/PythonCourse'))  # 'main.py'
'''
#  os.path.abspath(file.txt) - - возвращает полное имя пути (весь путь)
'''
import os

print(os.path.abspath('Seminar1.py'))
'''
